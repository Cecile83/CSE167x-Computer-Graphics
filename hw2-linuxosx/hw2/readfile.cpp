    ...
    while (in) {
      if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
        ...
        if (cmd == "light") {
	      ...
	      lightposn[4*(numused-1)+0] = values[0] ;
	      lightposn[4*(numused-1)+1] = values[1] ;
	      lightposn[4*(numused-1)+2] = values[2] ;
	      lightposn[4*(numused-1)+3] = values[3] ;
	      
	      lightcolor[4*(numused-1)+0] = values[4] ;
	      lightcolor[4*(numused-1)+1] = values[5] ;
	      lightcolor[4*(numused-1)+2] = values[6] ;
	      lightcolor[4*(numused-1)+3] = values[7] ;
	    ...
	    mat4 rot4=mat4(rot[0][0],rot[0][1],rot[0][2],0.,rot[1][0],rot[1][1],rot[1][2],0.,rot[2][0],rot[2][1],rot[2][2],0.,0.,0.,0.,1);
