...
{       
	...
	// On fait une boucle sur l'ensemble des lumières
	vec3 position, direction, half;
	...
	for (int i=0 ; i < numused ; i++)
	{
 	  ...
 	  { 
	    direction = normalize (lightposn[i].xyz);
 	    ...
 	    finalcolor += ComputeLight(direction, lightcolor[i], normal, half, diffuse, specular, shininess) ;
 	  } else {
